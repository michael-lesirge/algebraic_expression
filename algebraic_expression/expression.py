...
class Expression:
    ...
    def str_plus(self, *, plus=False, braces=False, sep="", html=False, up_symbol="**"):
        """
        ...
        for term in self.terms:
            final.append(term.str_plus(plus=(not first), html=html, up_symbol=up_symbol))
            first = False
    ...
    def __truediv__(self, other):
        ...
        if isinstance(other, Term):
            ...
            return sum([safe_int(self / other_term) for other_term in other.terms], start=Expression())
        return NotImplemented
